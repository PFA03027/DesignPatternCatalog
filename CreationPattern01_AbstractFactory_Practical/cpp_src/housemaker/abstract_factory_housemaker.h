...
class abstract_housemaker_factory {
    public:
        /**
         * @brief Abstract Factoryの具象クラスのインスタンスを生成する。
         * 
         * @return std::unique_ptr<abstract_housemaker_factory> 
         */
        static std::unique_ptr<abstract_housemaker_factory> generate_factory(void);
